...
public class GenService {
	...
	public static void genInterface(Class clazz) throws IOException,
			TemplateException {
		...
		String filename = ConfigurationManager.getGenFileDir() + "\\"
				+ data.get("serviceinterfacefilename");
	...
	public static void genService(Class clazz) throws IOException,
			TemplateException {
		Configuration cfg = ConfigurationManager.getConfiguration();
	 ...
	 */
	public static void genServiceAndInterface(EntityModel model) throws IOException,
			TemplateException {
		genInterface(model);
		genService(model);
	}
